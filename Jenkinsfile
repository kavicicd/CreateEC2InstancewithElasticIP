pipeline {
    ...
    stages {
        stage('Checkout') {
            steps {
                checkout scmGit(branches: [[name: '*/master']], extensions: [], userRemoteConfigs: [[credentialsId: 'kavirajravalji0410', url: 'https://github.com/kavirajravalji0410/CreateEC2InstancewithElasticIP.git']])
            }
        }
